...
class LinkedinEasyApply:
    ...
    def start_applying(self):
        ...
        for (position, location) in searches:
            ...
            job_page_number = str(job_page_number)
            ...
            try:
                while True:
                    page_sleep += 1
                    job_page_number = int(job_page_number) + 1
                    print("Going to job page", job_page_number)
    ...
    def next_job_page(self, position, location, job_page):
        self.browser.get("https://www.linkedin.com/jobs/search/" + str(self.base_search_url) +
                 "&keywords=" + str(position) + str(location) + "&start=" + str(job_page*25))
